...
public class EncoderTestMaster extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        {
            mechanicalDriveBase.strafeWithEncoders(COUNTS_PER_INCH * 24, true, 0.5, imuControl, telemetry);
            sleep(2000);
            mechanicalDriveBase.strafeWithEncoders(COUNTS_PER_INCH * 24, false, 0.5, imuControl, telemetry);
            sleep(2000);
        }
    }
}
